...
import { ToastTimeApplicationComponent } from '../toast-time-application/toast-time-application.component';
...
describe('ToastComponent', () => {
  ...
  configureTestBed({
    declarations: [ToastComponent, CdDatePipe, ToastTimeApplicationComponent],
    imports: [ToastrTestingModuleSuccess],
    providers: [DatePipe, ToastTimeApplicationComponent]
  });
