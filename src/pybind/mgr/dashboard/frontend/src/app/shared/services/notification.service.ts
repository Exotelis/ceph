...
export class NotificationService {
  ...
  constructor(public toastr: ToastrService, private taskMessageService: TaskMessageService, private overlayContainer: OverlayContainer) {
  ...
  removeNotificationById(id: number) {
    this.setContainerClass('block-ui', false);
  ...
  private setContainerClass(className: string, add=true) {
  ...
  private permToShow(config: CdNotificationConfig) {
    ...
    this.setContainerClass('block-ui');
